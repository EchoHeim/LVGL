...
#  define LIBINPUT_NAME   TOUCH_DEVICE        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
...
#  define EVDEV_NAME   TOUCH_DEVICE        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
